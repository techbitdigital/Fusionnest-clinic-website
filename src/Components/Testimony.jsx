  ...
  return (
    <div className="flex lg:justify-between justify-center p-2 lg:p-0 flex-col lg:flex-row my-16 lg:my-36 max-w-7xl m-auto">
      <div className="">
        ...
        <p className="text-[#808080] lg:w-[539px] my-3 text-lg">
        ...
        <button className="border mb-5 lg:mb-0 border-[#6E2C76] text-[#6E2C76]  p-2 px-8 text-lg rounded-lg">
          View All Testimonials
        </button>
      </div>
      <div className="space-y-10">
        <div className="bg-[#6E2C761A] p-5 rounded-lg flex-col lg:flex-row flex lg:space-x-5 text-lg">
          <img
            draggable="false"
          ...
          <div>
            ...
            <p className="lg:w-[368px] text-[#848484]">
